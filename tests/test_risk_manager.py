...
option_analysis = analysis.get_option_chain(NIFTY,expiry_date="2026-07-28")
...
assessment = risk_manager.assess(decision=decision_result,context=strategy_context,account=account)
